...
export default function SlideOverviewModal({
  ...
  return (
    <div className="fixed inset-0 z-50 bg-slate-950/90 backdrop-blur-xl flex flex-col p-6 md:p-10 animate-fade">
      {/* Modal Header */}
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-slate-400 font-sans">
              Select any slide thumbnail to jump directly into presentation mode.
            </p>
          </div>
        </div>
