  ...
  return (
    <div className="relative w-full h-full bg-[#F6F2EA] text-slate-900 p-8 md:p-12 flex flex-col justify-between overflow-hidden select-none font-sans">
      ...
      <svg className="absolute inset-0 w-full h-full pointer-events-none z-0">
        <line x1="20%" y1="35%" x2="80%" y2="35%" stroke="#C5A059" strokeWidth="1.5" className="animated-dash-line" opacity="0.3" />
        <line x1="20%" y1="70%" x2="50%" y2="70%" stroke="#05A872" strokeWidth="1.5" className="animated-dash-line" opacity="0.3" />
        <line x1="50%" y1="70%" x2="80%" y2="70%" stroke="#2563EB" strokeWidth="1.5" className="animated-dash-line" opacity="0.3" />
      </svg>
      ...
      <div className="relative z-10 grid grid-cols-12 gap-5 my-auto items-stretch">
          ...
          <div>
            <div className="flex items-center justify-between mb-3">
              <div className="flex items-center gap-2">
                <span className="font-serif text-3xl font-black text-[#C5A059]">01</span>
                <span className="text-[10px] font-mono font-bold tracking-widest text-[#C5A059] uppercase bg-[#C5A059]/10 px-2 py-0.5 rounded border border-[#C5A059]/30">
                  DOMAIN DEPTH
                </span>
              </div>
              <span className="text-[9px] font-mono font-bold px-2 py-0.5 rounded bg-[#C5A059] text-slate-950 uppercase tracking-wider">
                20+ YRS TRACK RECORD
              </span>
            </div>
            ...
            <div className="space-y-1.5 pt-3 border-t border-slate-800 text-xs font-semibold text-slate-200 font-sans">
              <div className="flex items-center gap-2">
        ...
        <div className="col-span-12 lg:col-span-6 bg-white border-2 border-emerald-400 p-6 md:p-7 rounded-2xl shadow-lg flex flex-col justify-between hover:-translate-y-1.5 transition-all duration-300 cursor-pointer">
          <div>
            <div className="flex items-center justify-between mb-3">
              <div className="flex items-center gap-2">
                <span className="font-serif text-3xl font-black text-[#05A872]">02</span>
                <span className="text-[10px] font-mono font-bold tracking-widest text-[#05A872] uppercase bg-emerald-50 px-2 py-0.5 rounded border border-emerald-200">
                  HIGHER-ED SPECIALISM
                </span>
              </div>
              <span className="text-[9px] font-mono font-bold px-2 py-0.5 rounded bg-[#05A872] text-white uppercase tracking-wider">
                5 FLAGSHIP PLATFORMS
              </span>
            </div>

            <h3 className="font-serif font-black text-2xl text-slate-900 mb-2 leading-tight">
              Tailored Exclusively for Higher Education
            </h3>
            <p className="text-xs text-slate-600 leading-relaxed font-sans font-light mb-4">
              UMS, AMS, Nexus & GMS are our core domain craft — not generic off-the-shelf modules or side offerings.
            </p>

            <div className="space-y-1.5 pt-3 border-t border-slate-200 text-xs font-semibold text-slate-700 font-sans">
              <div className="flex items-center gap-2">
        ...
        <div className="col-span-12 lg:col-span-4 bg-white border border-slate-300 p-5 rounded-2xl shadow-sm flex flex-col justify-between hover:-translate-y-1.5 transition-all duration-300 cursor-pointer">
          <div>
            <div className="flex items-center justify-between mb-2">
              ...
              <span className="text-[9px] font-mono font-bold px-2 py-0.5 rounded bg-red-100 text-red-700 border border-red-200 uppercase">
                100% ON-GROUND
              </span>
            </div>
            <h4 className="font-serif font-black text-lg text-slate-900 mb-1">Local Presence & Agility</h4>
            <p className="text-xs text-slate-600 leading-relaxed font-sans font-light mb-3">
              Dhaka-based delivery engineering — we know your institutions, your language, and your stakeholders.
            </p>
          </div>
          <div className="pt-2 border-t border-slate-100 text-[11px] font-semibold text-slate-700 space-y-1">
            <p className="flex items-center gap-1.5"><span className="text-red-600">✓</span> On-site support across 8 divisions</p>
            <p className="flex items-center gap-1.5"><span className="text-red-600">✓</span> Direct alignment with Ministry & UGC</p>
          </div>
        </div>
        ...
        <div className="col-span-12 lg:col-span-4 bg-white border border-slate-300 p-5 rounded-2xl shadow-sm flex flex-col justify-between hover:-translate-y-1.5 transition-all duration-300 cursor-pointer">
          <div>
            <div className="flex items-center justify-between mb-2">
              ...
              <span className="text-[9px] font-mono font-bold px-2 py-0.5 rounded bg-blue-100 text-blue-700 border border-blue-200 uppercase">
                3-YEAR SLA
              </span>
            </div>
            <h4 className="font-serif font-black text-lg text-slate-900 mb-1">Long-Term Support & DNA</h4>
            <p className="text-xs text-slate-600 leading-relaxed font-sans font-light mb-3">
              We don't disappear after go-live. Multi-year support is in our DNA, not a hidden contract clause.
            </p>
          </div>
          <div className="pt-2 border-t border-slate-100 text-[11px] font-semibold text-slate-700 space-y-1">
            <p className="flex items-center gap-1.5"><span className="text-blue-600">✓</span> 3-Year comprehensive maintenance SLA</p>
            <p className="flex items-center gap-1.5"><span className="text-blue-600">✓</span> Continuous security & feature upgrades</p>
          </div>
        </div>
        ...
        <div className="col-span-12 lg:col-span-4 bg-white border border-slate-300 p-5 rounded-2xl shadow-sm flex flex-col justify-between hover:-translate-y-1.5 transition-all duration-300 cursor-pointer">
          <div>
            <div className="flex items-center justify-between mb-2">
              ...
              <span className="text-[9px] font-mono font-bold px-2 py-0.5 rounded bg-amber-100 text-amber-800 border border-amber-300 uppercase">
                99.9% UPTIME SLA
              </span>
            </div>
            <h4 className="font-serif font-black text-lg text-slate-900 mb-1">Outcome-Driven Commitment</h4>
            <p className="text-xs text-slate-600 leading-relaxed font-sans font-light mb-3">
              We measure ourselves strictly on active user adoption, satisfaction, and system availability.
            </p>
          </div>
          <div className="pt-2 border-t border-slate-100 text-[11px] font-semibold text-slate-700 space-y-1">
            <p className="flex items-center gap-1.5"><span className="text-[#C5A059]">✓</span> 99.9% System Uptime SLA guarantee</p>
            <p className="flex items-center gap-1.5"><span className="text-[#C5A059]">✓</span> 24-Hour technical query resolution window</p>
          </div>
        </div>
      ...
      <div className="relative z-10 bg-white border-l-4 border-[#C5A059] border-t border-r border-b border-slate-300 p-3 rounded-r-xl shadow-xs text-center font-serif text-xs md:text-sm italic text-slate-900 font-bold">
